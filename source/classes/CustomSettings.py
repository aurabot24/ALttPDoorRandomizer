...
class CustomSettings(object):
    ...
    def create_from_world(self, world, settings):
        ...
        for p in self.player_range:
            ...
            settings_dict[p]['crystals_gt'] = world.crystals_needed_for_gt[p]
            settings_dict[p]['crystals_ganon'] = world.crystals_needed_for_ganon[p]
    ...
    def record_enemies(self, world):
        ...
        for player in self.player_range:
            ow_enemy_table = world.data_tables[player].ow_enemy_table
