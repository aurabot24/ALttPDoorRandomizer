...
item_table = {'Bow': (True, False, None, 0x0B, 200, 'Bow!\nJoin the archer class!', 'the stick and twine', 'arrow-slinging kid', 'arrow sling for sale', 'witch and robin hood', 'archer boy shoots again', 'the Bow'),
              ...
              'Pick Up Kiki': (True, False, 'Event', 999, None, None, None, None, None, None, None, None),
              'Dark Palace Opened': (True, False, 'Event', 999, None, None, None, None, None, None, None, None),
              ...
              'Sign Vandalized': (True, False, 'Event', 999, None, None, None, None, None, None, None, None),
